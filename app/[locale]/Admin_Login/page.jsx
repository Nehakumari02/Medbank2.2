          ...
          <div className='flex md:items-end w-full md:w-[527px] md:mt-[104px]'>
            <div className='w-full flex flex-col gap-[12px]'>
              ...
              <div className='flex flex-col gap-[6px] md:gap-[16px]'>
                ...
                <button disabled={loading} type="submit" onClick={handleLogin} className={`h-[38px] md:h-[50px] rounded-[6px] flex items-center justify-center [background:linear-gradient(180deg,_#60b7cf_10%,_#3e8da7_74.5%,_rgba(0,_62,_92,_0.6))] text-white font-DM-Sans font-bold text-[18px] leading-[24px] ${loading?"opacity-75":""} `}> {loading?<Loader2 className="animate-spin" /> : t('login')}</button>
              </div>
